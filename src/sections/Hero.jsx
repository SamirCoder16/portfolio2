...
const Hero = () => {
  const isMobile = useMediaQuery({ maxWidth: 853 });
      ...
      const text = `Exploring microservices, caching, 
      event-driven architecture, DSA and 
      system design to master scalable systems`;
  ...
  return (
    <section id="home" className="flex flex-col justify-end min-h-screen">
      ...
      >
        <Canvas shadows dpr={[1, 1.5]} camera={{ position: [0,0,-10], fov: 17.5, near: 1, far: 20 }}
        >
